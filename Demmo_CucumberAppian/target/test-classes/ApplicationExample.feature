...
Feature: Sample feature file that interacts with an Appian application
  ...
  Background: Login to Appian environment
    ...
    When I set appian URL to "https://yexledemo.appiancloud.com/suite/sites/automation-framework"
  ...
  Scenario: Fill out Automated Testing Data Input form
    When I populate field type " " named "Excel File" with "C:\Users\KiranPatil\Documents\TestData\pngImage.jpg"
